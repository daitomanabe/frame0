...
pub fn mock_devices() -> Vec<DeviceResource> {
    vec![
        ...
        DeviceResource {
            id: "device.mouse.mock.0".to_string(),
            device_type: "device.pointer_input".to_string(),
            vendor: "frame0.mock".to_string(),
            capabilities: vec!["pointer.mouse".to_string(), "pointer.input".to_string()],
            status: "available".to_string(),
            process: "plugin_host.mock_control".to_string(),
            permissions: vec![],
            modes: vec![DeviceMode {
                id: "normalized_window_buttons".to_string(),
                width: None,
                height: None,
                fps: Some(120.0),
                sample_rate: None,
        ...
        DeviceResource {
            id: "device.keyboard.mock.0".to_string(),
            device_type: "device.keyboard_input".to_string(),
            vendor: "frame0.mock".to_string(),
            capabilities: vec!["keyboard".to_string(), "keyboard.input".to_string()],
            status: "available".to_string(),
            process: "plugin_host.mock_control".to_string(),
            permissions: vec![],
            modes: vec![DeviceMode {
                id: "physical_key_layout".to_string(),
                width: None,
                height: None,
                fps: None,
                sample_rate: None,
        ...
        DeviceResource {
            id: "device.midi.mock.0".to_string(),
            device_type: "device.midi_input".to_string(),
            vendor: "frame0.mock".to_string(),
            capabilities: vec!["midi.input".to_string(), "midi.clock".to_string()],
            status: "available".to_string(),
            process: "plugin_host.mock_control".to_string(),
            permissions: vec![],
            modes: vec![DeviceMode {
                id: "midi_16ch".to_string(),
                width: None,
                height: None,
                fps: None,
                sample_rate: None,
        ...
        DeviceResource {
            id: "device.hid.mock.0".to_string(),
            device_type: "device.hid_input".to_string(),
            vendor: "frame0.mock".to_string(),
            capabilities: vec!["hid.input".to_string()],
            status: "available".to_string(),
            process: "plugin_host.mock_control".to_string(),
            permissions: vec![],
            modes: vec![DeviceMode {
                id: "vendor_reports".to_string(),
                width: None,
                height: None,
                fps: None,
                sample_rate: None,
        ...
        DeviceResource {
            id: "device.serial.mock.0".to_string(),
            device_type: "device.serial_input".to_string(),
            vendor: "frame0.mock".to_string(),
            capabilities: vec!["serial.input".to_string()],
            status: "available".to_string(),
            process: "plugin_host.mock_control".to_string(),
            permissions: vec![],
            modes: vec![DeviceMode {
                id: "115200_newline".to_string(),
                width: None,
                height: None,
                fps: None,
                sample_rate: None,
        ...
        DeviceResource {
            id: "device.multitouch.mock.0".to_string(),
            device_type: "device.multitouch_input".to_string(),
            vendor: "frame0.mock".to_string(),
            capabilities: vec!["touch.multitouch".to_string(), "touch.input".to_string()],
            status: "available".to_string(),
            process: "plugin_host.mock_control".to_string(),
            permissions: vec![],
            modes: vec![DeviceMode {
                id: "normalized_10_touch".to_string(),
                width: None,
                height: None,
                fps: Some(120.0),
                sample_rate: None,
...
mod tests {
    ...
    #[test]
    fn mock_devices_cover_input_events() {
        for capability in [
            "pointer.mouse",
            "keyboard",
            "midi.input",
            ...
            assert!(
                ...
                "missing mock input device capability {capability}"
            );
        }
    }
}
