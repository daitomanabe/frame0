...
- Examples: `hello_shader`, `headless_render`, `camera_to_shader`, `audio_reactive`, `mock_sdk_input`, `native_ml`, `camera_extension_output`, `auv3_audio_unit`, `extension_multi_output`
